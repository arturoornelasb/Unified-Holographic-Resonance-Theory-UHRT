...
def main():
    print("--- STARTING HOLOGRAPHIC RESONANCE THEORY SIMULATION (STABLE) ---")
    ...
    try:
        ...
        plt.title('UHRT Simulation (Stable State)')
        
        # --- FILENAME CORRECTION ---
        plt.savefig("uhrt_simulation_stable.png")
        print("\n3D visualization saved to 'uhrt_simulation_stable.png'")
        plt.close(fig) 
